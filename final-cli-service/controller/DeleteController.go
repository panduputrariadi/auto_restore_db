...
func DeleteFileWithWorker(chin chan model.DatabaseConfig, worker int) chan model.DatabaseConfig {
	...
	//Fan-in
	for i := 0; i < worker; i++ {
		channels = append(channels, service.GoroutineDeleteFile(chin))
	}
